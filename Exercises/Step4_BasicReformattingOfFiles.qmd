---
title: "Step4 Basic Reformatting of Files - Part 1"
...
How many rows are left for il6? 
...
crp <- crp %>%
  mutate(across(
    matches("_[123]$|_[123]_[a-z]$") & #two conditions to mutate across, the first is that it has a suffix
      !matches("^Well"), #the second condition is that it does NOT matc the Well columns
