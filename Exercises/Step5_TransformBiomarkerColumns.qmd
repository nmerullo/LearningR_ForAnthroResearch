---
title: "Step5 Transform Biomarker columns - Part 2"
...
recall there is no Plate_ThirdRun  in this one so you need to remove it from the select()
...
mutate() creates a column or modifies an exisiting one based on what is on the other side of =. str_pad() "pads" a vector based on the specifications of width and pad arguments. So here we used a width of 3 and add 0s to the short ID column, saved as a character string.
